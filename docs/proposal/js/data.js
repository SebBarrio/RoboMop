...
window.RPT = {
  ...
  ask: {
    ...
    projectCap: 378000,
    minDelivery: "1 robot + 1 acumulador LFP + 1 cargador + software + paquete técnico",
  ...
  decisions: {
    sbc: {
      pick: "Jetson Orin Nano 8GB Super Dev Kit", vendor: "NVIDIA",
      cost: "kit de desarrollo Super $249 · módulo $249 @1KU",
      power: "7–15 W (25 W MAXN Super)", tops: "67 TOPS · 1024 CUDA + 32 Tensor",
      mem: "8 GB LPDDR5 · 102 GB/s", supply: "clase ~5 años (NVIDIA FAQ)",
      verdict: "RECOMENDADO",
    },
    mcu: {
      pick: "ESP32-S3-WROOM-1 N16R8", vendor: "Espressif",
  ...
  objectives: [
    ...
    { id: "OBJ-02", obj: "Controlar el costo del proyecto", crit: "Hardware base MXN $49,739.85 · contingencia Sponsor MXN $7,460.98 · forecast de hardware MXN $57,200.83 · Project Manager MXN $160,000 · Senior Engineer MXN $160,000 · servicios totales MXN $320,000 · presupuesto total planeado MXN $377,200.83" },
  ...
  risks: [
    ...
    { id: "R10", risk: "El alcance de software excede la capacidad", lvl: 7, response: "Clases y contratos de congelación; priorizar la ruta de aceptación de la Semana 10", trigger: "Integración incompleta en la Semana 10" },
  ...
  changeClasses: [
    { cls: "Clase 1", cond: "Sin costo externo y sin impacto en la ruta crítica, las interfaces o la seguridad", appr: "Project Manager" },
    { cls: "Clase 2", cond: "Costo ≤ MXN $1,000 e impacto ≤ 2 días, sin reducción de seguridad, sin uso de contingencia y sin activar Clase 3", appr: "Project Manager + Lead Robotics & Systems Engineer" },
  ...
  acceptanceMatrix: [
    ...
    { id: "ACC-04", req: "Paro e inhibición", target: "E-stop e inhibición llevan las salidas de tracción al estado seguro, impiden rearranque automático y requieren reset deliberado; tiempo/distancia congelados en SRR antes de pruebas móviles", evidence: "Osciloscopio, video y fault injection", rep: "Cada modo/falla", waiver: "No" },
    ...
    { id: "ACC-08", req: "Limpieza e irrigación", target: "≥90% remoción del patrón de suciedad acordado; flujo dentro de ±15% del setpoint; 0 fugas hacia electrónica y sin charcos fuera del límite acordado", evidence: "Before/after, flujo y leak test", rep: "3 zonas", waiver: "No para fuga" },
    ...
    { id: "ACC-11", req: "Seguridad eléctrica/térmica", target: "0 trips inesperados, celdas fuera de límites, conductores/conectores sobre su rating ni acceso de agua a electrónica", evidence: "Logs, inspección y fault/leak tests", rep: "Matriz completa", waiver: "No" },
  ...
  defectClasses: [
    ...
    { cls: "P1", meaning: "Mayor, sin hazard crítico", rule: "Cierre antes de FAT; excepción con decisión escrita Sponsor + Senior Engineer, justificación, impacto, workaround y corrección ≤10 días hábiles" },
  ...
  team: [
    ...
    { role: "Project Manager", name: "Germán Velázquez", resp: "Responsable del alcance, calendario, costo, partes, compras, riesgos, cambios y documentación; es su único punto de contacto y coordina la línea de trabajo de software." },

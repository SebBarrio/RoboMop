...
window.RPT = {
  ...
  meta: {
    ...
    version: "Propuesta de proyecto v1.0 · para aprobación",
    issued: "2026-07-16",
    compiled: "2026-07-21",
  ...
  ask: {
    ...
    committedEarly: 0.8408, // fracción de la base comprometible en semanas 1–2
  },
  ...
  bomTable: [
    ...
    { item: "PCBs a la medida", spec: "PCB 1 de potencia/tren motriz (drivers de motores + rieles DC-DC) y PCB 2 portadora Jetson — fabricación, componentes, ensamble, impuesto provisional", qty: "2 tarjetas", mxn: 3478, status: "ESTIMATE" },
  ...
  gates: [
    { id: "G0", week: 0, name: "Inicio", crit: "Propuesta y financiamiento aprobados" },
    ...
    { id: "G3", week: 8, name: "Subsistemas listos", crit: "Cada subsistema demostrado independientemente" },
    { id: "G4", week: 12, name: "Funciones completas", crit: "Robot completamente integrado; congelación de funciones" },
    { id: "G5", week: 14, name: "Verificación completa", crit: "Matriz de pruebas completa ejecutada" },
    { id: "G6", week: 16, name: "Aceptación final", crit: "Usted acepta la entrega y los riesgos residuales" },
  ],

  // Objetivos medibles
  objectives: [
    { id: "OBJ-01", obj: "Entregar el producto final en 16 semanas", crit: "Prueba de Aceptación Final y entrega en la Semana 16" },
    { id: "OBJ-02", obj: "Controlar el costo del proyecto", crit: "Base MXN $47,097.85 · BAC MXN $54,162.53 · techo MXN $55,000" },
  ...
  freeze: [
    "Números de parte finales: celdas, BMS, LiDAR, IMU, controlador, PCBs",
    ...
    "Métricas de localización, cobertura, limpieza, percepción y frenado",
    "Límites ambientales y superficies de la Prueba de Aceptación Final",
  ...
  scopeOut: [
    ...
    "Mano de obra dentro del presupuesto de materiales",
  ],

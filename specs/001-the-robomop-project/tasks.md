...
- [ ] **T091** WebSocket client in robot/src/communication/websocket_client.py (Socket.io client, auto-reconnect)
...
- [ ] **T121** Sensor fusion integration in robot/src/slam/sensor_fusion.py (EKF combining LIDAR, IMU, encoders)
